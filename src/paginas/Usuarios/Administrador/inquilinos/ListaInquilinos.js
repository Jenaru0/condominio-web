      ...
      <TableBody>
        {inquilinos.map((inquilino) => (
          ...
          >
            ...
            <TableCell>
              {inquilino.propietario_asociado?.name || "Sin propietario"}
            </TableCell>
            <TableCell>
              {inquilino.habitacion_id?.numero || "Sin departamento"}
            </TableCell>
            <TableCell>{inquilino.habitacion_id?.piso || "Sin piso"}</TableCell>
            <TableCell>
              {inquilino.habitacion_id?.edificio_id?.nombre || "Sin edificio"}
            </TableCell>
            <TableCell>
              <Button
                startIcon={<Edit />}
