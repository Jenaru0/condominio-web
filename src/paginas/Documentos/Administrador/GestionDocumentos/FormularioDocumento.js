...
const FormularioDocumento = ({ open, onClose, documento, onSave }) => {
    ...
    const handleSubmit = () => {
        if (!form.nombre_documento || !form.tipo || !form.fecha_expiracion) {
            alert("Todos los campos son obligatorios.");
            return;
        }
        onSave({ ...form, id: documento?.id || Date.now() });
        onClose();
    };
        ...
        >
            ...
            >
                ...
                >
                    ...
                    >
                        Completa los siguientes campos para {documento ? "editar" : "subir"} un
                        documento.
                    </Typography>
                    <Box
                        component="form"
                ...
                >
                    ...
                    >
                        {documento ? "Guardar Cambios" : "Subir"}
                    </Button>
                </DialogActions>
            </motion.div>
        </Dialog>
